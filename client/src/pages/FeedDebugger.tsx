...
import { ArrowLeft, BarChart3, Search, Command } from "lucide-react";
...
export default function FeedDebugger() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col" data-testid="feed-debugger">
      <header className="glass-panel border-b border-white/[0.06] px-4 py-2 flex items-center gap-3 shrink-0">
        ...
        <BarChart3 className="w-4 h-4 text-signal-blue" />
        <span className="font-mono text-sm font-bold tracking-tight text-foreground">FEED DEBUGGER</span>
